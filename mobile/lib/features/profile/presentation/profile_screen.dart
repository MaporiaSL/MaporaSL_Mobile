      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            _DataBlock(
              label: 'IMPACT FACTOR',
              value: profile.impactCount.toString(),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _LegacyStat(label: 'GEMS SUBMITTED', value: profile.totalSubmitted.toString()),
                  const SizedBox(width: 32),
                  _LegacyStat(label: 'APPROVAL RATE', value: '${profile.approvalRate.toStringAsFixed(1)}%'),
                ],
              ),
            ],
          ),
