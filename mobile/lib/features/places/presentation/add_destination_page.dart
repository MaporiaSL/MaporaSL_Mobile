...
class _AddDestinationPageState extends State<AddDestinationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add a Hidden Gem', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: _isLoading 
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: _selectedImage == null 
                        ? Column(
                            ...
                            children: [
                              ...
                              Text('Tap to upload a photo (Optional)', style: TextStyle(color: Colors.blue.shade700, fontWeight: FontWeight.bold)),
                            ],
                          )
                        : null,
                    ),
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Place Name', border: OutlineInputBorder(), prefixIcon: Icon(Icons.landscape)),
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'District / City', border: OutlineInputBorder(), prefixIcon: Icon(Icons.pin_drop)),
                  ...
                  TextFormField(
                    ...
                    maxLines: 4,
                    decoration: const InputDecoration(labelText: 'Description & Tips', border: OutlineInputBorder(), alignLabelWithHint: true),
                    validator: (v) => v!.length < 10 ? 'Add a short description (min 10 chars)' : null,
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: const Text('Add to MaporaSL', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
