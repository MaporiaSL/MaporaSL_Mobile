  ...
  static ThemeData light({bool highContrast = false}) {
    ...
    return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        surfaceContainerHighest: highContrast ? Colors.white : AppColors.surfaceMuted,
  ...
  static ThemeData dark({bool highContrast = false}) {
    ...
    return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        onErrorContainer: const Color(0xFFFFC8C8),
        surface: highContrast ? Colors.black : AppColors.surfaceDark,
        onSurface: Colors.white,
        surfaceContainerHighest: highContrast ? Colors.black : const Color(0xFF1B2430),
